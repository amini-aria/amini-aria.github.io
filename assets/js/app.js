(function () {
  ...
  /* ---------- Aria's Lab: typewriter title, plays once on scroll-into-view ---------- */
  var labTitleEl = document.getElementById("lab-title-text");
  if (labTitleEl && "IntersectionObserver" in window) {
    var fullText = labTitleEl.getAttribute("data-text") || "";
    var typed = false;
      ...
      entries.forEach(function (entry) {
        if (entry.isIntersecting && !typed) {
          ...
          var iv = setInterval(function () {
            i++;
            labTitleEl.textContent = fullText.slice(0, i);
